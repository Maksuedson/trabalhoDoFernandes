...
//                        p.setTelefone(in.nextInt());
                ...
                case 4:
                    ...
                    if (p.exibir(professores).length() > 0) {
                        ...
                        System.out.print("Digite o telefone: ");
                        professor.setTelefone((int) in.nextLong());
                        System.out.print("Digite o sexo: (F para FEMININO e M para MASCULINO)");
            ...
            switch (opcao) {
                ...
                case 4:
                    ...
                    if (a.exibir(alunos).length() > 1) {
                        ...
                        System.out.print("Digite o telefone: ");
                        aluno.setTelefone((int) in.nextLong());
                        System.out.print("Digite o sexo: (F para FEMININO e M para MASCULINO)");
        ...
        try {
            ...
            switch (opcao) {
                case 1:
                    ...
                    f.setEndereco(end);
                    System.out.print("Digite o telefone: ");
                    f.setTelefone((int) in.nextLong());
                    System.out.print("Digite o sexo: (F para FEMININO e M para MASCULINO)");
                    f.setSexo(in.next().toUpperCase());
                    cadastrar(f);
                    menuFuncionario();
                    break;
                case 2:
                    if (funcionarios.isEmpty()) {
                        ...
                        f.exibir(funcionarios);
                    }
                    menuFuncionario();
                    break;
                case 3:
                    Funcionario al = new Funcionario();
                    if (f.exibir(funcionarios).length() > 1) {
                        System.err.println(f.exibir(funcionarios));
                        menuFuncionario();
                    } else {
                        System.out.println("Digite o RA do aluno que deseja pesquisar: ");
                        al.setRegistro(in.next());
                        pesquisar(al);
                    }
                    break;
                case 4:
                    ...
                    if (f.exibir(funcionarios).length() > 1) {
                        ...
                        do {
                            System.out.println("Digite o ID do aluno que deseja editar: ");
                            indice = in.nextInt();
                            func = funcionarios.get(indice - 1);
                        } while (func == null);
                        System.out.println("Editando o aluno de ID: " + (indice));
                        System.out.print("Digite o nome: ");
                        func.setNome(in.nextLine());
                        System.out.print("Digite o REGISTRO: ");
                        func.setRegistro(in.next());
                        System.out.print("Digite a Função: ");
                        func.setFuncao(in.next());
                        System.out.println("Endereço do aluno: ");
                        System.out.print("Digite o UF: ");
                        end.setUf(in.next());
                        System.out.print("Digite a cidade: ");
                        ...
                        System.out.print("Digite o telefone: ");
                        func.setTelefone((int) in.nextLong());
                        System.out.print("Digite o sexo: (F para FEMININO e M para MASCULINO)");
                        func.setSexo(in.next().toUpperCase());
                        editar(func, indice);
                        System.out.println("Aluno de ID " + indice + " editado com sucesso.");
                        func = null;
                        menuAluno();
                ...
                case 5:
                    if (f.exibir(alunos).length() > 1) {
                        ...
                        indice = in.nextInt();
                        indice--;
                        Funcionario alo = funcionarios.get(indice);
                        excluir(indice, alo);
                        menuFuncionario();
                    }
                    break;
    ...
    public static void cadastrar(Funcionario f) {
        funcionarios.add(f);
        System.out.println("FUNCIONÁRIO " + f.getNome() + " DE RA " + f.getRegistro()+ " CADASTRADO COM SUCESSO.");
    }
    ...
    public static void editar(Funcionario f, int indice) {
        funcionarios.add(indice, f);
    }
    ...
    public static void pesquisar(Funcionario a) {
        for (Funcionario al : funcionarios) {
            if (al.getRegistro().equals(a.getRegistro())) {
                System.out.println("Resultado: ");
                System.out.println("Aluno ID " + (alunos.indexOf(al) + 1));
                System.out.println("Nome: " + al.getNome());
                System.out.println("Registro: " + al.getRegistro());
                System.out.println("Função: " + al.getFuncao());
                System.out.println("Endere�o do aluno:\nUF: " + al.getEndereco().getUf()
                        + "           Cidade: " + al.getEndereco().getCidade()
                        + "           Bairro: " + al.getEndereco().getBairro());
                System.out.println("Rua: " + al.getEndereco().getRua()
    ...
    public static void excluir(int indice, Funcionario a) {
        Scanner in = new Scanner(System.in);
        System.out.println("Excluir o funcionário de nome: " + funcionarios.get(indice).getNome() + ""
                + " de Registro: " + funcionarios.get(indice).getRegistro()+ "?\nS - SIM\nN - N�O");
        String opcao = in.next();
        if (opcao.equalsIgnoreCase("s")) {
